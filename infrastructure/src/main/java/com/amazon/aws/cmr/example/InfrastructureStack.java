...
public class InfrastructureStack extends Stack {
    ...
    public InfrastructureStack(final Construct scope, final String id, final StackProps props) {
        ...
        Function exampleCustomRuntime = new Function(this, "LambdaCustomRuntimeMinimalJRE19", FunctionProps.builder()
                .functionName("lambda-custom-runtime-minimal-jre-19")
                .description("lambda-custom-runtime-minimal-jre-19")
